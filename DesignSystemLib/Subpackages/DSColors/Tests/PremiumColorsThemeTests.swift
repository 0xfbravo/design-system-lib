...
final class PremiumColorsThemeTests: XCTestCase {
    
    private let theme = PremiumColorsTheme()
    ...
    func testFillColors() {
        XCTAssertEqual(theme.fill.mainBackground, .loadColor("Premium Main Background"))
    }
